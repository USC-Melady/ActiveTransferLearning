function [Xs] = generate_1d_synthetic_data_S3(N)
% GENERATE_1D_SYNTHETIC_DATA_S1(N) Generates random 1D S3 source data set
...
% cluster 2
Xs = [ Xs; rand(nc,1)*0.75 + 1.25 ];
% cluster 3
Xs = [ Xs; rand(floor(nc),1)*0.75 + 0.25 ];
% cluster 4
Xs = [ Xs; rand(floor(nc),1)*0.75 + 2 ];
